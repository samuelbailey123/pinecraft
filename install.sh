...
# I don't distribute the installers with Pinecraft directly since
...
if [[ $mcverANY == "1" ]] || [[ $mcver == "1.16.5" ]] || [[ $mcver == "1.17.1" ]] || [[ $mcver == "1.18" ]] || [[ $mcver == "1.18.1" ]] || [[ $mcver == "1.18.2" ]] || [[ $mcver == "1.19" ]] || [[ $mcver == "1.19.2" ]] || [[ $mcver == "1.19.3" ]] || [[ $mcver == "1.19.4" ]] || [[ $mcver == "1.20.1" ]] || [[ $mcver == "1.20.2" ]]; then
...
if [[ $? == 0 ]]; then
  case $result in
    ...
    R)
      ...
      flavor="Forge"
      if [[ $mcver == "1.20.2" ]]; then
        url="https://maven.minecraftforge.net/net/minecraftforge/forge/1.20.2-48.0.23/forge-1.20.2-48.0.23-installer.jar"
      elif [[ $mcver == "1.20.1" ]]; then
        ...
        url="https://maven.minecraftforge.net/net/minecraftforge/forge/1.19-41.0.110/forge-1.19-41.0.110-installer.jar"
      elif [[ $mcver == "1.18.2" ]]; then
        url="https://maven.minecraftforge.net/net/minecraftforge/forge/1.18.2-40.1.45/forge-1.18.2-40.1.45-installer.jar"
      elif [[ $mcver == "1.18.1" ]]; then
    ...
    P)
      ...
      flavor="Paper"
      if [[ $mcver == "1.20.2" ]]; then
        url="https://api.papermc.io/v2/projects/paper/versions/1.20.2/builds/233/downloads/paper-1.20.2-233.jar"
      elif [[ $mcver == "1.20.1" ]]; then
